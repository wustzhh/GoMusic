...
void _logMs(String msg) {
  try {
    ...
    File(
      ...
      '[${DateTime.now().toIso8601String().substring(11, 19)}] [MS] $msg\n',
...
class _GoMusicAppState extends State<GoMusicApp> with WidgetsBindingObserver {
  ...
  ThemeData _buildTheme(SkinStyle skin, Brightness brightness) {
    ...
    final cardBorder = ui.cardStyle == SkinCardStyle.neon || ui.neonGlow
        ? BorderSide(
            color: ui.buttonBorder == Colors.transparent
    ...
    final buttonShape = switch (ui.buttonShape) {
      ...
      SkinButtonShape.cutCorner => const BeveledRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(2)),
      ),
      SkinButtonShape.hexagon => const BeveledRectangleBorder(
        borderRadius: BorderRadius.all(Radius.circular(8)),
      ),
      SkinButtonShape.pixel => const BeveledRectangleBorder(
        borderRadius: BorderRadius.zero,
      ),
      SkinButtonShape.rounded => RoundedRectangleBorder(borderRadius: radius),
    };
    final buttonSide = ui.buttonBorder == Colors.transparent
        ? null
        : BorderSide(color: ui.buttonBorder, width: 1.2);
    ...
    final normalizedTextTheme = baseTextTheme.copyWith(
      ...
      displaySmall: normalizeLetterSpacing(baseTextTheme.displaySmall),
      headlineLarge: normalizeLetterSpacing(baseTextTheme.headlineLarge),
      headlineMedium: normalizeLetterSpacing(baseTextTheme.headlineMedium),
      headlineSmall: normalizeLetterSpacing(baseTextTheme.headlineSmall),
      titleLarge: normalizeLetterSpacing(baseTextTheme.titleLarge),
      titleMedium: normalizeLetterSpacing(baseTextTheme.titleMedium),
      titleSmall: normalizeLetterSpacing(baseTextTheme.titleSmall),
      bodyLarge: normalizeLetterSpacing(baseTextTheme.bodyLarge),
      bodyMedium: normalizeLetterSpacing(baseTextTheme.bodyMedium),
      bodySmall: normalizeLetterSpacing(baseTextTheme.bodySmall),
      labelLarge: normalizeLetterSpacing(baseTextTheme.labelLarge),
      labelMedium: normalizeLetterSpacing(baseTextTheme.labelMedium),
      labelSmall: normalizeLetterSpacing(baseTextTheme.labelSmall),
    );
    final textTheme = normalizedTextTheme
        .apply(
          fontFamily: ui.fontFamily,
          letterSpacingFactor: ui.letterSpacingFactor,
        )
        .copyWith(
          titleLarge: normalizedTextTheme.titleLarge?.copyWith(
            fontFamily: ui.fontFamily,
            fontWeight: ui.fontWeight,
          ),
          titleMedium: normalizedTextTheme.titleMedium?.copyWith(
            fontFamily: ui.fontFamily,
            fontWeight: ui.fontWeight,
          ),
          bodyLarge: normalizedTextTheme.bodyLarge?.copyWith(
            fontFamily: ui.fontFamily,
            fontWeight: ui.fontWeight,
          ),
          bodyMedium: normalizedTextTheme.bodyMedium?.copyWith(
            fontFamily: ui.fontFamily,
            fontWeight: ui.fontWeight,
          ),
          labelLarge: normalizedTextTheme.labelLarge?.copyWith(
            fontFamily: ui.fontFamily,
            fontWeight: ui.fontWeight,
          ),
        );
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        color: ui.cardStyle == SkinCardStyle.metal
            ...
            : cardColor,
        elevation: ui.cardStyle == SkinCardStyle.neon
            ? 4
            : (ui.cardStyle == SkinCardStyle.metal ? 2 : 0),
        shadowColor: ui.buttonShadow == Colors.transparent
            ? skin.accent.withValues(alpha: 0.18)
            : ui.buttonShadow,
        shape: RoundedRectangleBorder(borderRadius: radius, side: cardBorder),
      ),
      // AppBar：动态皮肤透明融入背景
      appBarTheme: AppBarTheme(
        backgroundColor: ui.appBarTransparent
            ? Colors.transparent
            : scheme.surface,
        elevation: 0,
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        selectedIconTheme: IconThemeData(
          size: ui.navStyle == SkinNavStyle.rail ? 28 : 24,
        ),
      ),
      // 按钮：全局圆角随主题
      filledButtonTheme: FilledButtonThemeData(
        style: ButtonStyle(
          ...
          shadowColor: WidgetStatePropertyAll(
            ui.buttonShadow == Colors.transparent
                ? skin.accent
                : ui.buttonShadow,
          ),
          ...
          overlayColor: WidgetStateProperty.resolveWith((states) {
            if (states.contains(WidgetState.pressed))
              return skin.accent.withValues(alpha: 0.24);
            if (states.contains(WidgetState.hovered))
              return skin.accent.withValues(alpha: 0.12);
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ButtonStyle(
          ...
          backgroundColor: WidgetStatePropertyAll(
            buttonBackground ?? ui.buttonStart,
          ),
          foregroundColor: const WidgetStatePropertyAll(Colors.white),
          side: WidgetStatePropertyAll(buttonSide),
          shadowColor: WidgetStatePropertyAll(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: ButtonStyle(
          ...
          side: WidgetStatePropertyAll(
            buttonSide ?? BorderSide(color: skin.accent.withValues(alpha: 0.6)),
          ),
          foregroundColor: WidgetStatePropertyAll(skin.accent),
        ),
      ),
      splashFactory: ui.buttonFeedback == SkinButtonFeedback.scanline
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderRadius: radius,
          borderSide: BorderSide(color: skin.accent.withValues(alpha: 0.35)),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: radius,
          borderSide: BorderSide(color: skin.accent, width: 1.6),
        ),
      ),
