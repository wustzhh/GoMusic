...
enum SkinNavIndicator { pill, underline, bracket, glow, diamond }
...
class UiStyle {
  ...
  final SkinButtonFeedback buttonFeedback;
  final SkinNavIndicator navIndicator;
  ...
  const UiStyle({
    ...
    this.buttonFeedback = SkinButtonFeedback.ripple,
    this.navIndicator = SkinNavIndicator.pill,
...
class Skins {
  ...
  static final plainLight = SkinStyle(
    ...
    ui: UiStyle(
      radius: 8,
      glassy: false,
      buttonShape: SkinButtonShape.rounded,
      cardStyle: SkinCardStyle.paper,
      navStyle: SkinNavStyle.solid,
      fontFamily: 'Georgia',
      fontWeight: FontWeight.w500,
      letterSpacingFactor: 1.02,
      buttonFeedback: SkinButtonFeedback.lift,
      navIndicator: SkinNavIndicator.underline,
      buttonStart: Color(0xFF5E35B1),
      buttonEnd: Color(0xFF7E57C2),
      buttonBorder: Color(0xFF4527A0),
      inputFill: Color(0x12000000),
      controlSurface: Color(0x14000000),
    ),
  );
  static final plainDark = SkinStyle(
    ...
    ui: UiStyle(
      radius: 8,
      glassy: false,
      buttonShape: SkinButtonShape.pixel,
      cardStyle: SkinCardStyle.flat,
      navStyle: SkinNavStyle.segmented,
      fontFamily: 'Courier New',
      fontWeight: FontWeight.w700,
      letterSpacingFactor: 0.92,
      buttonFeedback: SkinButtonFeedback.bounce,
      navIndicator: SkinNavIndicator.bracket,
      buttonStart: Color(0xFF4A148C),
      buttonEnd: Color(0xFF7B1FA2),
      buttonBorder: Color(0xFFCE93D8),
      inputFill: Color(0x18FFFFFF),
      controlSurface: Color(0x18000000),
    ),
  );
  ...
  static final aurora = SkinStyle(
    ...
    ui: UiStyle(
      ...
      cardStyle: SkinCardStyle.glass,
      navStyle: SkinNavStyle.glass,
      fontFamily: 'Segoe UI',
      fontWeight: FontWeight.w600,
      letterSpacingFactor: 1.04,
      buttonFeedback: SkinButtonFeedback.glowPulse,
      navIndicator: SkinNavIndicator.glow,
      buttonStart: Color(0xFF7C4DFF),
      buttonEnd: Color(0xFF00BFA5),
      buttonBorder: Color(0x889CFFEE),
      buttonShadow: Color(0x557C4DFF),
      inputFill: Color(0x22FFFFFF),
      dialogOpacity: 0.88,
      controlSurface: Color(0x2280FFEA),
    ),
    animated: true,
    dark: true,
  );
  ...
  static final cyberNeon = SkinStyle(
    ...
    ui: UiStyle(
      ...
      appBarTransparent: true,
      navTransparent: true,
      buttonShape: SkinButtonShape.cutCorner,
      cardStyle: SkinCardStyle.neon,
      navStyle: SkinNavStyle.rail,
      fontFamily: 'Consolas',
      fontWeight: FontWeight.w700,
      letterSpacingFactor: 0.88,
      buttonFeedback: SkinButtonFeedback.scanline,
      navIndicator: SkinNavIndicator.bracket,
      buttonStart: Color(0xFF00F0FF),
      buttonEnd: Color(0xFFFF2E9A),
      buttonBorder: Color(0xFF00F0FF),
      buttonShadow: Color(0xAA00F0FF),
      inputFill: Color(0x2218D7FF),
      dialogOpacity: 0.9,
      controlSurface: Color(0x2218D7FF),
    ),
    animated: true,
    dark: true,
  );
  ...
  static final rainbow = SkinStyle(
    ...
    ui: UiStyle(
      ...
      appBarTransparent: true,
      navTransparent: true,
      buttonShape: SkinButtonShape.hexagon,
      cardStyle: SkinCardStyle.glass,
      navStyle: SkinNavStyle.segmented,
      fontFamily: 'Trebuchet MS',
      fontWeight: FontWeight.w600,
      letterSpacingFactor: 1.08,
      buttonFeedback: SkinButtonFeedback.ripple,
      navIndicator: SkinNavIndicator.diamond,
      buttonStart: Color(0xFFFF5252),
      buttonEnd: Color(0xFF29B6F6),
      buttonBorder: Color(0xFFFFA726),
      buttonShadow: Color(0x66FF5252),
      inputFill: Color(0x22FFFFFF),
      dialogOpacity: 0.9,
      controlSurface: Color(0x221E1E2A),
    ),
    animated: true,
    dark: true,
  );
  ...
  static final galaxy = SkinStyle(
    ...
    ui: UiStyle(
      ...
      buttonFeedback: SkinButtonFeedback.lift,
      navIndicator: SkinNavIndicator.pill,
      buttonStart: Color(0xFF4C3FFF),
      buttonEnd: Color(0xFF00CFFF),
      buttonBorder: Color(0x889CA8FF),
      buttonShadow: Color(0x554C3FFF),
      inputFill: Color(0x20FFFFFF),
      dialogOpacity: 0.9,
      controlSurface: Color(0x222F6BFF),
    ),
    animated: true,
    dark: true,
  );
  ...
  static final flame = SkinStyle(
    ...
    ui: UiStyle(
      ...
      navTransparent: true,
      buttonShape: SkinButtonShape.cutCorner,
      cardStyle: SkinCardStyle.metal,
      navStyle: SkinNavStyle.segmented,
      fontFamily: 'Impact',
      fontWeight: FontWeight.w700,
      letterSpacingFactor: 0.94,
      buttonFeedback: SkinButtonFeedback.bounce,
      navIndicator: SkinNavIndicator.glow,
      buttonStart: Color(0xFFFF7A00),
      buttonEnd: Color(0xFFFF2E2E),
      buttonBorder: Color(0xFFFFC107),
      buttonShadow: Color(0x88FF3D00),
      inputFill: Color(0x26FF6D00),
      dialogOpacity: 0.92,
      controlSurface: Color(0x33120607),
    ),
    animated: true,
    dark: true,
  );
  ...
  static final electric = SkinStyle(
    ...
    ui: UiStyle(
      ...
      fontWeight: FontWeight.w700,
      letterSpacingFactor: 0.9,
      buttonFeedback: SkinButtonFeedback.glowPulse,
      navIndicator: SkinNavIndicator.diamond,
      buttonStart: Color(0xFF00E0FF),
      buttonEnd: Color(0xFF169BFF),
      buttonBorder: Color(0xFF00E0FF),
      buttonShadow: Color(0x8800E0FF),
      inputFill: Color(0x22169BFF),
      dialogOpacity: 0.9,
      controlSurface: Color(0x22169BFF),
    ),
    animated: true,
    dark: true,
  );
...
/// 全局界面皮肤通知（设置页切换时更新，动态背景/主题色/按钮实时响应）。
/// 默认：极光（启动即有动态背景）
