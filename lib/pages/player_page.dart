...
class _PlayerPageState extends State<PlayerPage> {
  ...
  void _refresh() {
    ...
    if (_song != null) {
      AudioPlayerService.isFavorite(_song!.filePath).then((f) {
  ...
  void _toggleFav() {
    ...
    AudioPlayerService.toggleFavorite(_song!.filePath);
      ...
      builder: (_) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: PlayMode.values.map((m) {
          ...
          return ListTile(
            ...
            title: Text(_label(m), style: TextStyle(color: sel ? Colors.deepPurple : null)),
  ...
  String _label(PlayMode m) { switch (m) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text(''), actions: [
        if (_song!.hasVideo)
          TextButton.icon(onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (_) => VideoDetailPage(song: _song!))); },
              icon: const Icon(Icons.ondemand_video, size: 16), label: const Text('源视频')),
      ]),
      body: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          GestureDetector(onTap: _showModeMenu,
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Text(_service.playModeLabel, style: TextStyle(fontSize: 14, color: Colors.grey[600])),
      ...
      child: Column(children: [
        Padding(padding: const EdgeInsets.all(16), child: Row(children: [
          ...
          GestureDetector(
            ...
            child: Text(p.playModeLabel, style: TextStyle(fontSize: 13, color: Colors.grey[600])),
          ),
        ])),
        Expanded(child: queue.isEmpty
          ...
          : ListView.builder(itemCount: queue.length, itemBuilder: (_, i) {
              ...
              return ListTile(
                ...
                title: Text(s.title, style: TextStyle(fontSize: 14, fontWeight: isCur ? FontWeight.bold : FontWeight.normal), overflow: TextOverflow.ellipsis),
