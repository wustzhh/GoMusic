        ...
        actions: [
          ...
          TextButton(onPressed: () {
            ...
            try {
              ...
              final audioExists = song.filePath.isNotEmpty && File(song.filePath).existsSync();
              if (!audioExists && song.coverUrl != null && song.coverUrl!.isNotEmpty && File(song.coverUrl!).existsSync()) {
